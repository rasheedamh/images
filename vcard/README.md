...
Static vCard hosted on GitHub Pages at **https://rasheedamh.github.io/images/vcard/**.
...
| `/.nojekyll` (repo root) | Disables Jekyll processing for the whole site. |
| `qr-card.png` | 2460 x 2460 px, 600 dpi, error-correction level H. Encodes `https://rasheedamh.github.io/images/vcard/`. |

## Setup

1. Push these files to the `main` branch of the `images` repo (this folder stays at `vcard/`).
2. Repo **Settings → Pages**: Source "Deploy from a branch", branch `main`, folder `/ (root)`.
3. The site is live at https://rasheedamh.github.io/images/vcard/ about a minute later.
...
```
curl -sI https://rasheedamh.github.io/images/vcard/contact.vcf | grep -i content-type
```
...
Open `https://rasheedamh.github.io/images/vcard/?stay` to view the landing page without the auto-redirect.
